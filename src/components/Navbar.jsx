...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full flex justify-between items-center px-8 h-20 bg-on-primary/90 backdrop-blur-md docked full-width z-50 shadow-xl shadow-indigo-900/20 dark:shadow-none">
