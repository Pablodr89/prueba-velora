export default function Button({
  ...
  const typeStyles = {
    ...
    SECONDARY:
      "px-4 py-2 bg-surface-container-highest text-primary font-bold text-sm rounded-lg flex items-center gap-2 hover:bg-primary hover:text-white transition-all",
    TERTIARY:
